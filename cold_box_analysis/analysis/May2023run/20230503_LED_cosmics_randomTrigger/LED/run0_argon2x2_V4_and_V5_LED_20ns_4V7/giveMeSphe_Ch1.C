...
void giveMeSphe_Ch1(){
    ...
    dark.start  = 6330;            // start the search for peaks or start the integration (led)
    dark.finish = 6450;        // fisish the search or finish the integration (led)
    ...
    dark.spe_max_val_at_time_cut = 48; // after `time_cut`, the signal cannot be higher than this
