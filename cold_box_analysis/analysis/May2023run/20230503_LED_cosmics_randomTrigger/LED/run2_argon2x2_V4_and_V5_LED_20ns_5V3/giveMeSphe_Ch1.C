...
void giveMeSphe_Ch1(){
    ...
    dark.finish = 6430;        // fisish the search or finish the integration (led)
    ...
    dark.sphe_charge   = 2651; // charge of 1 and 2 p.e. (use fit_sphe.C)
    dark.sphe_charge2  = 5115.63;
    dark.sphe_std      = 684.189;
