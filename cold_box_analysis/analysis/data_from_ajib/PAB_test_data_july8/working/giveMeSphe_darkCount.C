...
void giveMeSphe_darkCount(){
    ...
    dark.start = 5100; // start the search for peaks or start the integration (led)
    dark.finish = 5400; // fisish the search or finish the integration (led)
    ...
    dark.sphe_charge_ch0 = 1.64849; // wave0
    dark.sphe_charge2_ch0 = 3.2926; // wave0
    dark.deltaplus = 1.35;
    dark.deltaminus = 1.4;
