...
void create_histograms_ch5(){
  string mychannel = "Ch5";
  string device = "miniArapuca 37V";
  if(mychannel == "Ch6") device = "miniArapuca 47";
  vector<string> files = {"run0_47V00_20ADC_led_7V_50ns", "run1_47V00_20ADC_led_5V_50ns", "run2_47V00_20ADC_led_6V_50ns", "run3_47V00_20ADC_led_7V5_50ns", "run4_47V00_20ADC_led_10V_50ns", "run5_47V00_20ADC_led_12V5_50ns", "run6_47V00_20ADC_led_15V_50ns", "run7_47V00_20ADC_led_17V5_50ns", "run8_47V00_20ADC_led_20V_50ns", "run9_47V00_20ADC_led_22V5_50ns", "run10_47V00_20ADC_led_25V_50ns", "run10_47V00_20ADC_led_27V5_50ns", "run11_47V00_20ADC_led_30V_50ns"};
  vector<Double_t> volts = {7,5,6,7.5,10,12.5,15,17.5,20,22.5,25,27.5,30};
  Int_t n = volts.size();
  ...
  vector<TH1D*> h(n);
  vector<TH1D*> hpeak(n);
  TH2D *h2p = new TH2D("h2p","h2p",500,-5,50,2000,-100,3000);
