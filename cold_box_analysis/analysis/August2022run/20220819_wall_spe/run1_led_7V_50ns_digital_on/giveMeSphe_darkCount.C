...
void giveMeSphe_darkCount(){
    ...
    dark.start = 5320; // start the search for peaks or start the integration (led)
    dark.finish = 5548; // fisish the search or finish the integration (led)
    ...
    dark.sphe_charge2_ch0 = 10402.7; // wave0
    dark.deltaplus = 1.35;
    dark.deltaminus = 1.4;
