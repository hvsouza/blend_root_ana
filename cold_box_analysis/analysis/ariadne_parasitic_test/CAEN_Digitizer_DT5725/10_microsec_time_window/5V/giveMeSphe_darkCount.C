...
void giveMeSphe_darkCount(){
    ...
    dark.start = 4080; // start the search for peaks or start the integration (led)
    dark.finish = 4160; // fisish the search or finish the integration (led)
    ...
    dark.sphe_charge_ch0 = 1561.81; // wave0
    dark.sphe_charge2_ch0 = 2690.53; // wave0
    dark.deltaplus = 2.1;
