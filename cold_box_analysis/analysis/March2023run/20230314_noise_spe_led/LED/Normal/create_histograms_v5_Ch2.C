...
void create_histograms_v5_Ch2(){
  ...
  if(mychannel == "Ch5."){minInt = 10300; maxInt = 10500;}
  if(mychannel == "Ch6."){minInt = 10300; maxInt = 10550;}
  ...
  vector<Double_t> sphes = {7100,400, 7100, 1, 4200, 350, 2500, 0};
  ...
  vector<TH1D*> h(n);
  vector<TH1D*> hpeak(n);
  TH2D *h2p = new TH2D("h2p","h2p",4000,-5,4000,2000,-100,15000);
