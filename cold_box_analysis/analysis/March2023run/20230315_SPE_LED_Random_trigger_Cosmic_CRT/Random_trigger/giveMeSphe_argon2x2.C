...
void giveMeSphe_argon2x2(){
    ...
    dark.timeLow         = 80; // integration time before peak (not used for led)
    dark.timeHigh        = 220; // integration time after peak (not used for led)
    ...
    dark.waiting         = 2000;
    dark.filter          = 54;  // one dimentional denoise filter (0 equal no filder)
