...
void plot_wvfs_v5_ch1(){
  ...
  if(mychannel == "Ch6."){minInt = 2600; maxInt = 3500;}
  ...
  vector<string> files = {
                          "run28_argon2x2_v4_v5_trigger_Ch6_800ADC",
                          "run29_argon2x2_v4_v5_trigger_Ch6_3000ADC"
                          };
