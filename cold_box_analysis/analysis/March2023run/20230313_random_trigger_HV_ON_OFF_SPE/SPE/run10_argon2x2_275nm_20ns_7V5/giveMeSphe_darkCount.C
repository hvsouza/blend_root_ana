...
void giveMeSphe_darkCount(){
    ...
    dark.start  = 10270;            // start the search for peaks or start the integration (led)
    ...
    dark.sphe_charge   = 6171.03; // charge of 1 and 2 p.e. (use fit_sphe.C)
    dark.sphe_charge2  = 12220.1;
    dark.sphe_std      = 1102;
