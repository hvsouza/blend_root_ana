...
void giveMeSphe_Ch2(){
    ...
    dark.start  = 10300;            // start the search for peaks or start the integration (led)
    ...
    dark.sphe_charge   = 319.421; // charge of 1 and 2 p.e. (use fit_sphe.C)
    dark.sphe_charge2  = 623.848;
    dark.sphe_std      = 110.857;
