...
void giveMeSphe_Ch1(){
    ...
    dark.start  = 8688;            // start the search for peaks or start the integration (led)
    dark.finish = 8832;        // fisish the search or finish the integration (led)
    ...
    dark.mean_before   = 7000;   // time recorded before and after the peak found
    dark.mean_after    = 13000;
    ...
    dark.time_cut = 2450; // in ns seconds
