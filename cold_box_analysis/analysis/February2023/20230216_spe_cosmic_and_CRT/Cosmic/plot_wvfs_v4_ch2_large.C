...
void plot_wvfs_v4_ch2_large(){
  ...
  vector<string> files = {"./run7_cosmic_all_trigger_xArapuca_v4_Ch1_2000ADCs",
                          "./run8_cosmic_all_trigger_xArapuca_v4_Ch1_400ADCs"};
  ...
  Double_t sphe = 1;
  vector<vector<Double_t>> group_amp = {{30,40}, {70,80}, {100,200}, {500,600}, {800,900}, {1000,1100}, {1500,1600}, {1800,1900}};
