...
void create_histograms_flex(){
  ...
  if(mychannel == "Ch2"){minInt = 10120; maxInt = 10500;}
  ...
  if(mychannel == "Ch7"){minInt = 10100; maxInt = 12000;}
  ...
  vector<Double_t> sphes = {7100,400, 1300, 1, 5800, 2500, 2500, 2800};
  ...
  vector<TH1D*> h(n);
  vector<TH1D*> hpeak(n);
  TH2D *h2p = new TH2D("h2p","h2p",4000,-5,4000,2000,-100,16500);
