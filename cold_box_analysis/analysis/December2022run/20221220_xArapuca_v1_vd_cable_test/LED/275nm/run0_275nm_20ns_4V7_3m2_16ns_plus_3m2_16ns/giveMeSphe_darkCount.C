...
void giveMeSphe_darkCount(){
    ...
    dark.start = 10144; // start the search for peaks or start the integration (led)
    dark.finish = 10616; // fisish the search or finish the integration (led)
    ...
    dark.sphe_charge_ch0 = 1463.29; //wave0
    dark.sphe_charge2_ch0 = 3013; // wave0
