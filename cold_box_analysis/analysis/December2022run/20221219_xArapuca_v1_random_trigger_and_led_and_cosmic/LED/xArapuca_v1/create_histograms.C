...
void create_histograms(){
  ...
  string mychannel = "Ch7";
  vector<string> devices = {"0","0","miniArapuca 37V (A1ch1)","miniArapuca 47V (Argon4)", "xArapuca v4 ch1 (DCemArgon4)", "xArapuca v4 ch2 (DCemArgon4)", "xArapuca v5 ch1 (DCemSimp3)", "xArapuca v1 (DCemVD)"};
  vector<Double_t> saturations = {0, 0, 12600, 12600, 12000, 12000, 12000, 16500};
  vector<Double_t> sphes = {0,0, 7000, 400, 441*6, 0, 0, 1600};

  vector<string> files = {"run23_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_3V2", "run24_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_3V4", "run25_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_3V6", "run26_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_3V8", "run27_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_4V0", "run28_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_4V2", "run29_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_4V4", "run30_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_4V6", "run31_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_4V8", "run32_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_5V0", "run33_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_5V2", "run34_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_6V2", "run35_v5_and_argon2x2_off_xArapuca_v1_on_365nm_20ns_7V5"};

  vector<Double_t> volts = {3.2, 3.4, 3.6, 3.8, 4.0, 4.2, 4.4, 4.6, 4.8, 5.0, 5.2, 6.2, 7.5};
  ...
  vector<TH1D*> h(n);
  vector<TH1D*> hpeak(n);
  TH2D *h2p = new TH2D("h2p","h2p",4000,-5,5000,2000,-100,16400);
  TH2D *h2 = new TH2D("h2","h2",300,0,30,8000,-50,5000);
  ...
  for(Int_t i = 0; i<n; i++){
    ...
    if(mychannel == "Ch7"){minInt = 10140; maxInt = 11000;}
