...
void ffts(){
  zall.setAnalyzer("run0_all_devices_random_trigger/analyzed.root");
  znov5.setAnalyzer("run1_v5_turned_off_random_trigger/analyzed.root");
  znopof.setAnalyzer("run2_v5_and_v4_turned_off_random_trigger/analyzed.root");
