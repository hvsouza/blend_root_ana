...
void adc_read_all_data_led(){
    ...
    r.baselineTime = 10000; // time limit for baseline
    r.chargeTime = 12000; // last time to integrate
    r.startCharge = 10280;
    ...
    r.exclusion_baselines = {30,5,35,5,10}; // filtered waveform, anything above here will do +exclusion window
