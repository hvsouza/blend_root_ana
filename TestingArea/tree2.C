...
void tree2r()
{
   ...
   TBranch *b_lmec = t2->GetBranch("lmec");
   TBranch *b_nmec = t2->GetBranch("nmec");
   b_destep->SetAddress(&destep);
   b_lmec->SetAddress(&gstep.lmec);
   b_nmec->SetAddress(&gstep.nmec);
   ...
   for (Long64_t i=0;i<nentries;i++) {
     ...
     b_lmec->GetEntry(i);
     b_nmec->GetEntry(i);
     for(Int_t j = 0; j<gstep.nmec; j++){
       cout << j << " " << gstep.lmec[j] << " " << sizeof(gstep.lmec)/sizeof(gstep.lmec[0]) << endl;
     }
     cout << "\n";
   }
